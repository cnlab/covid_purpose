...
surveys = read.csv("covid19_study1_qualtrics.csv", stringsAsFactors = FALSE) %>%
  slice(3:n()) %>%
...
# write csvs
```{r}
write.csv(surveys_clean, "covid19_study1_clean_long.csv", row.names = FALSE)
write.csv(surveys_wide, "covid19_study1_clean_wide.csv", row.names = FALSE)
```
